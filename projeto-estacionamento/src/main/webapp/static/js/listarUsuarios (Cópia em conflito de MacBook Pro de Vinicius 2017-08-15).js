			...
			if (data.usuarios.length > 0){ 	
				...
				$.each(data.usuarios, function(i, obj){
					if(obj.tipoUsuario.id!=1){
						...
						.append($("<td/>").html("<a class='btn btn-primary' href='/admin/carregarUser/" + obj.id + "'+>Editar</a>" +
				...
				if (data.usuarios.length > 0){ 	
					...
					$.each(data.usuarios, function(i, obj){
						if(obj.tipoUsuario.id!=1){
							...
							u += '<td class="march"><a class="btn btn-primary" href="/admin/carregarUser/' + obj.id + '">Editar</a>';
