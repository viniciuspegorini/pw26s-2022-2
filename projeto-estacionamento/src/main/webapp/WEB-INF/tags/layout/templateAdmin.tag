		...
		<div class="menu">
			<ul id="menu">
				<li><a href="<c:url value="/admin/"/>"><i
						class="fa fa-tachometer"></i> <span>Solicitações</span></a></li>
				<li id="menu-academico-avaliacoes"><a
					href="<c:url value="/admin/tercerizado/cadastrar"/>"><i
						class="fa fa-user"></i>Cadastrar Externo</a></li>
				<li id="menu-academico-avaliacoes"><a
					href="<c:url value="/admin/listarUsuarios"/>"><i
						class="fa fa-user"></i>Funcionarios</a></li>
				<li id="menu-academico-avaliacoes"><a
					href="<c:url value="/admin/listarInfracoes"/>"><i
						class="fa fa-user"></i>Justificar Infração</a></li>
				<li><a href="<c:url value="/login"/>"> <i
						class="fa fa-sign-out"></i> <span>Sair</span>
				</a></li>
			</ul>
		</div>
